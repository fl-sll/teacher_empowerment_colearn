 ...
 * @description Route file for managing metrics-related API endpoints in the Teacher Empowerment API.
 * @version 1.0.0
 * @date 2025-01-02
 * @authors 
 *   - Edward Alvin
 ...
 * 
 * @details
 * This file defines the routes for CRUD operations and other endpoints related to metrics.
